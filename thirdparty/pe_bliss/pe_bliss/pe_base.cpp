...
//Returns whether or not file is a dll
bool pe_base::is_dll() const
{
	return check_characteristics_flag(pe_win::image_file_dll);
}

//Returns whether or not file is an exe
bool pe_base::is_exe() const
{
	return check_characteristics_flag(pe_win::image_file_executable_image);
}
